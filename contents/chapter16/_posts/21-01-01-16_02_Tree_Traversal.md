...
Có cây rồi, câu hỏi tiếp theo gần như luôn là: làm sao đi qua các nút theo một thứ tự có ý nghĩa? Khi duyệt thư mục, render DOM, tính giá trị của biểu thức cú pháp hay tìm kiếm trên cây quyết định, thứ tự thăm nút quyết định trực tiếp hành vi của thuật toán.
...
**Duyệt cây** chính là bộ công cụ để làm việc đó. Các cách duyệt như preorder, inorder, postorder hay level order không chỉ khác nhau ở trình tự, mà còn phù hợp với các mục tiêu xử lý khác nhau.

Trong khoa học máy tính, phần này rất thực tế. Một chiến lược duyệt đúng có thể giúp serialize cấu trúc, đánh giá biểu thức, tìm kiếm, sao chép hay xóa cây một cách tự nhiên và hiệu quả.

Trong bài này, chúng ta sẽ học các cách duyệt cơ bản và thấy ngay ứng dụng của từng cách trong các bài toán quen thuộc.
...
**Demo tương tác đề xuất**: Chọn kiểu duyệt trên một cây tìm kiếm nhị phân cố định và quan sát thứ tự các nút được thăm.
<div data-demo="tree-traversal-animation"></div>
</div>
<script src="{{ '/public/js/tree-traversal-animation.js' | relative_url }}"></script>
