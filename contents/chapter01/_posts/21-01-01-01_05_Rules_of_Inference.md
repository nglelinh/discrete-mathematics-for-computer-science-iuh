...
## 11. Sai lầm Thường gặp (Fallacies)

Không phải mọi suy luận trông "hợp lý" đều đúng. Hai sai lầm phổ biến nhất:

### 11.1. Sai lầm Khẳng định Hệ quả (Fallacy of Affirming the Consequent)
...
q \\
\hline
\therefore p \quad \text{(SAI!)}
\end{array}
$$

Đây **không phải** quy tắc suy diễn hợp lệ. $$p \to q$$ và $$q$$ đúng không cho phép ta kết luận $$p$$ đúng.
...
> Đường ướt. ($$q$$)
> ————————————
> $$\therefore$$ Trời mưa. (SAI — có thể do xe cứu hỏa phun nước)

### 11.2. Sai lầm Phủ định Tiền đề (Fallacy of Denying the Antecedent)
...
> Nếu là admin thì có quyền truy cập. ($$p \to q$$)
> Không phải admin. ($$\neg p$$)
> ————————————————
> $$\therefore$$ Không có quyền truy cập. (SAI — user thường vẫn có quyền cơ bản)
