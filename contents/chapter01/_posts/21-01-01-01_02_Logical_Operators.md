...
![Biểu đồ Venn: phép AND (∧)](https://commons.wikimedia.org/wiki/Special:FilePath/Venn-Diagram-AND.png?width=400)
...
![Biểu đồ Venn: phép OR (∨)](https://commons.wikimedia.org/wiki/Special:FilePath/Venn-Diagram-OR.png?width=400)
...
![Biểu đồ Venn: mệnh đề kéo theo (→)](https://commons.wikimedia.org/wiki/Special:FilePath/Venn-Diagram-Implication.PNG?width=400)

*Hình 1.9: Mệnh đề kéo theo p → q — chỉ sai khi p đúng mà q sai; khi p sai thì luôn đúng (vacuously true).*

![Biểu đồ Venn: phép XOR (⊕)](https://commons.wikimedia.org/wiki/Special:FilePath/Venn-Diagram-XOR.png?width=400)
