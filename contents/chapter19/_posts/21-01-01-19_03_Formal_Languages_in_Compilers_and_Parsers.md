...
![Noam Chomsky — phân cấp ngôn ngữ hình thức](https://commons.wikimedia.org/wiki/Special:FilePath/Noam_Chomsky.jpg?width=640)
...
![Phân cấp Chomsky — sức mạnh grammar và máy chấp nhận](https://commons.wikimedia.org/wiki/Special:FilePath/Chomsky_hierarchy.svg?width=640)
...
![Lexical analysis — tách mã nguồn thành token](https://commons.wikimedia.org/wiki/Special:FilePath/Lexical_analysis.png?width=640)
...
![Cây cú pháp trừu tượng (AST)](https://commons.wikimedia.org/wiki/Special:FilePath/Abstract_syntax_tree.svg?width=640)

*Hình 19.14: AST — biểu diễn cấu trúc chương trình sau parser; input cho type checker và code generator.*

![Parse tree — mọi bước suy diễn grammar](https://commons.wikimedia.org/wiki/Special:FilePath/Parse_tree.png?width=640)
