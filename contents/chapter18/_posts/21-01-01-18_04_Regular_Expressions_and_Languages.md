...
![Biểu thức chính quy](https://commons.wikimedia.org/wiki/Special:FilePath/DFA_example.svg?width=640)

*Hình 18.16: Regex mô tả ngôn ngữ chính quy — cùng lớp với DFA và NFA.*

![Thompson construction](https://commons.wikimedia.org/wiki/Special:FilePath/NFA_example.svg?width=640)

*Hình 18.17: Xây NFA từ regex — mỗi toán tử regex tương ứng mẫu NFA nhỏ.*

![Kleene star](https://commons.wikimedia.org/wiki/Special:FilePath/Finite_state_machine.svg?width=640)

*Hình 18.18: Toán tử $*$ (lặp 0 hoặc nhiều lần) — nền tảng cú pháp regex.*

![Lexical analysis](https://commons.wikimedia.org/wiki/Special:FilePath/Decision_tree.svg?width=640)

*Hình 18.19: Trình biên dịch dùng FSM/regex để phân tích từ vựng — tokenize mã nguồn.*

![Lớp ngôn ngữ chính quy](https://commons.wikimedia.org/wiki/Special:FilePath/Chomsky_hierarchy.svg?width=640)
