...
![Tháp Hà Nội — bài toán đệ quy kinh điển](https://commons.wikimedia.org/wiki/Special:FilePath/Tower_of_Hanoi.gif?width=640)
...
![Dãy hình học — tăng trưởng theo tỷ lệ](https://commons.wikimedia.org/wiki/Special:FilePath/Geometric_sequence.svg?width=640)
...
![Dãy số học — tổng tích lũy](https://commons.wikimedia.org/wiki/Special:FilePath/Arithmetic_progression.svg?width=640)
