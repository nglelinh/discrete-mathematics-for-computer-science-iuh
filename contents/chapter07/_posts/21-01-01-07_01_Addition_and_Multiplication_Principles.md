...
![Cây quyết định — quy tắc nhân](https://commons.wikimedia.org/wiki/Special:FilePath/Decision_tree.svg?width=640)
...
![Phép hợp hai tập rời nhau](https://commons.wikimedia.org/wiki/Special:FilePath/Union_of_sets_A_and_B.svg?width=640)
...
![Tính số hoán vị — quy tắc nhân](https://commons.wikimedia.org/wiki/Special:FilePath/Permutation_count_calculation.svg?width=640)
