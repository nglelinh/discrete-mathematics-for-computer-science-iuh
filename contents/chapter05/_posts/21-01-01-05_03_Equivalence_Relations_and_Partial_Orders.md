...
Khi hệ thống cần gom các đối tượng “giống nhau theo một tiêu chí”, hoặc sắp chúng theo một quan hệ “so được phần nào”, ta đang bước vào hai cấu trúc cực kỳ quan trọng: **quan hệ tương đương** và **thứ tự bộ phận**. Chúng xuất hiện trong phân lớp dữ liệu, version control, dependency graph, phân quyền nhiều tầng và cả cách tổ chức tri thức.

Quan hệ tương đương giúp chia thế giới thành các lớp không chồng lấn; thứ tự bộ phận giúp mô tả những cấu trúc có trước-sau, chứa-trong hay phụ-thuộc nhưng không phải lúc nào cũng so sánh được hoàn toàn. Hiểu hai mô hình này là hiểu cách máy tính nhóm và sắp xếp thông tin mà không làm mất bản chất của nó.
...
<div class="interactive-tool" data-tool="relation-classifier">
