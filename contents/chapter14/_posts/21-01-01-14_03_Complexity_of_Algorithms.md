...
Sau khi biết cách mô tả tốc độ tăng trưởng bằng Big-O, câu hỏi tự nhiên là: cụ thể thì **một thuật toán phải trả giá bao nhiêu** về thời gian và bộ nhớ? Không phải bài toán nào cũng nên giải bằng brute force, và không phải lời giải “đẹp” nào cũng đủ rẻ để triển khai ở quy mô thật.

Phân tích **độ phức tạp của thuật toán** là nghệ thuật bóc tách chi phí ẩn sau từng vòng lặp, từng lời gọi đệ quy, từng cấu trúc dữ liệu. Nó giúp ta dự đoán hiệu năng trước khi code chạy ở production, tránh các thiết kế tưởng ổn nhưng sẽ sụp khi lưu lượng tăng, và hiểu sâu hơn vì sao hai thuật toán đúng như nhau lại khác xa về giá trị thực tiễn.
