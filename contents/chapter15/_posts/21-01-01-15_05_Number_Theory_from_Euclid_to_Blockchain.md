...
![Euclid và Gauss](https://commons.wikimedia.org/wiki/Special:FilePath/Euclid.jpg?width=640)

*Hình 15.21: Từ Euclid đến Gauss, number theory xây nền trí tuệ cho công nghệ bảo mật hiện đại.*

![Modulo và hashing](https://commons.wikimedia.org/wiki/Special:FilePath/Modular_arithmetic.svg?width=640)

*Hình 15.22: Đồng dư và modulo sống trong hashing, indexing và hạ tầng số học của phần mềm.*

![RSA và HTTPS](https://commons.wikimedia.org/wiki/Special:FilePath/RSA_diagram.svg?width=640)

*Hình 15.23: RSA bảo vệ kết nối HTTPS — người dùng web âm thầm dựa vào lý thuyết số.*

![Blockchain](https://commons.wikimedia.org/wiki/Special:FilePath/Blockchain_scheme.svg?width=640)

*Hình 15.24: Blockchain kết hợp hashing, chữ ký số và đồng thuận — lý thuyết số gặp hệ phân tán.*

![Zero-knowledge proofs](https://commons.wikimedia.org/wiki/Special:FilePath/Carl_Friedrich_Gauss.jpg?width=640)
